...
SET(RASPBIAN_ROOTFS "$ENV{HOME}/berry/")

if(${RASPBIAN_ROOTFS} STREQUAL "")
...
SET(TOOLCHAIN_ROOT "/opt/cross-pi-gcc/bin")
message(STATUS "Using sysroot path: ${SYSROOT_PATH}")

set(TOOLCHAIN_CC "${TOOLCHAIN_ROOT}/${TOOLCHAIN_HOST}-gcc")
set(TOOLCHAIN_CXX "${TOOLCHAIN_ROOT}/${TOOLCHAIN_HOST}-g++")
set(TOOLCHAIN_LD "${TOOLCHAIN_ROOT}/${TOOLCHAIN_HOST}-ld")
set(TOOLCHAIN_AR "${TOOLCHAIN_ROOT}/${TOOLCHAIN_HOST}-ar")
set(TOOLCHAIN_RANLIB "${TOOLCHAIN_ROOT}/${TOOLCHAIN_HOST}-ranlib")
set(TOOLCHAIN_STRIP "${TOOLCHAIN_ROOT}/${TOOLCHAIN_HOST}-strip")
set(TOOLCHAIN_NM "${TOOLCHAIN_ROOT}/${TOOLCHAIN_HOST}-nm")
...
SET(Poco_DIR "/home/dan/Projects/PocoInstall/lib/cmake/Poco" CACHE PATH "Path to Poco libs" FORCE)

SET(RPI "" CACHE STRING "for identifiying that the platform is rpi" FORCE)
